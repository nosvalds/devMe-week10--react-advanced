...
const Footer = () => {
    ...
    <footer>
        <nav className="nav navbar-light bg-light justify-content-center">
            ...
            <Link className="btn btn-secondary m-2" to="/03-01-basic-hooks">Basic Hooks</Link>
            <Link className="btn btn-secondary m-2" to="/03-02-reducer-hooks">Reducer Hooks</Link>
